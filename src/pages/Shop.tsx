                  ...
                  <div className="p-6">
                    ...
                    <div className="flex gap-2">
                      <Link
                        ...
                        className="flex-1 bg-emerald-600 text-white text-center py-3 rounded-lg font-semibold hover:bg-emerald-700 transition-colors"
                      >
                        View Details
                      </Link>
                      <button className="px-4 py-3 border-2 border-emerald-600 text-emerald-600 rounded-lg hover:bg-emerald-600 hover:text-white transition-colors">
